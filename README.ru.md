...
Граница ролей одна и та же в одиночной работе и под оркестрацией: worker свою работу принятой не объявляет, файлы задач между каталогами не двигает, находки заводит `new --parent N[.M]`.
