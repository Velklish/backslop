...
| [`../archive/`](../archive/README.md) | Closed: `task.md` + `result.md`; minor entries in the batch's `minor/` | `{{cli}} archive N`, then complete `result.md`; a minor entry — `{{cli}} archive N.k --into M` once batch M is closed |
