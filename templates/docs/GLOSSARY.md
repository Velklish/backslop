...
Нормативный словарь терминов {{project}}. Тексты проекта используют только имена отсюда: одно понятие — одно имя. Встретилось второе написание — либо оно попадает в «Убранные слова» как замена, либо вычищается из текста.
