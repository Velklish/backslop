...
// Ветки moveFile (lib/tasks.js) по коду возврата неразличимы; различает след в индексе — у `git mv`
// переименование, у renameSync удаление и неотслеживаемый файл — и предупреждение второй.
