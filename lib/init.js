...
import {
  BLOCK_END, BLOCK_MARKERS, BLOCK_START, CONFIG_FILE, LANGS, PREFIX_RE, STATUSES, defaultCli, defaults, expectDirectory, findRoot, isProjectPath, layout, loadConfig, parseCli, saveConfig, validateConfig,
} from './config.js';
...
function upsertBlock(file, current, block, lang = 'ru') {
  if (current === null) {
