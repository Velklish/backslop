...
import {
  FIELD_AREA, FIELD_COST, FIELD_CREATED, FIELD_DEPS, FIELD_ORDER, FIELD_PARENT, FIELD_PREV_ORDER, FIELD_TAKEN, SECTION_DEFERRED, canonicalId, fieldName, fieldOccurrences, getField, idMentionRe, orderOf, parseCost, readText, readTitle, scanTasks,
...
function lintLog({ root, cfg, dirs }, tasks, err) {
  ...
  if (existsSync(file)) {
    ...
    for (const e of readLogText(text, cfg.prefix)) {
