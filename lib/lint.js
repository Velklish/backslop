...
import {
  FIELD_AREA, FIELD_COST, FIELD_CREATED, FIELD_DEPS, FIELD_ORDER, FIELD_PARENT, FIELD_TAKEN, SECTION_DEFERRED, canonicalId, fieldName, fieldOccurrences, getField, idMentionRe, orderOf, parseCost, readText, readTitle, scanTasks,
...
function lintStatusFields({ root, cfg }, tasks, err) {
  ...
  for (const t of tasks) {
    ...
    for (const name of [FIELD_ORDER, FIELD_AREA, FIELD_CREATED, FIELD_TAKEN, FIELD_DEPS, FIELD_PARENT, FIELD_COST]) {
