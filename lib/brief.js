...
import { CliError, parseCommandArgs, warn } from './util.js';
...
// Команду пробы знает только проект: нет поля — нет и предложения в брифе (ADR-021). Текст
// правила берётся из `agents-probe.md`, как у managed-блока AGENTS.md: источник у обоих один.
function probeStep(cfg) {
