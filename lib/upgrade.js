...
// Гейт со старой командой получает новую, запись с областью правится внутрь и сохраняет `when`.
// Нетронутая запись — та же ссылка: число заменённых считается сравнением с исходным списком.
