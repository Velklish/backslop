...
// Кандидаты на снятие: файл с маркером, путь текущего шаблона и legacy-путь. Совпадение с шаблоном
// только называет кандидата, удаляет `isOwnedAdapterFile` (ADR-006).
