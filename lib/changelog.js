...
export async function run(argv) {
  ...
  if (values.since !== undefined && since === null) throw new CliError(`--since «${values.since}»: нужна форма X.Y.Z`);
  if (values.to !== undefined && to === null) throw new CliError(`--to «${values.to}»: нужна форма X.Y.Z`);
