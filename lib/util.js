...
// Потолок вывода git: умолчание spawnSync в 1 МиБ обрывает `ENOBUFS` крупный коммит и длинную историю.
...
// Причина отказа git: stderr, иначе ошибка запуска (ENOENT, ENOBUFS, ETIMEDOUT), иначе сигнал или код.
