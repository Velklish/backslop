...
import {
  FIELD_AREA, FIELD_COST, FIELD_CREATED, FIELD_TAKEN, SECTION_DEFERRED, getField, queueOrder, readText, readTitle, scanTasks, sectionBody,
} from './tasks.js';
...
export function renderStatus(s, lang = 'ru') {
  const lines = [];
