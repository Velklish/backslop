...
export const MIGRATIONS = [
  ...
  },
  {
    ...
    // Заводит пустой журнал и больше ничего: свёрнутые записи и каталоги архива живут рядом
    // сколько угодно долго, и апгрейд не сносит накопленное молча — свёртка идёт отдельным
    // ходом `fold` ([ADR-026](../docs/adr/adr-026-archive-folds-to-log.md)).
    run({ cfg, dirs }) {
